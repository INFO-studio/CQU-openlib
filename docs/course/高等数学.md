...
=== ":material-book:`MATH10821`"  
    ...
    * 期中试卷  
        * [试卷+答案](http://api.cqu-openlib.cn/file?key=iBq8i3f685eh) - :material-calendar:`2025秋` - :material-tag:`A卷`  
    ...
    * 期末试卷  
        * [最全试卷资料包](http://api.cqu-openlib.cn/file?key=idP553gwifyj) @阳启万象
    ...
    * [上册快速复习PPT](http://api.cqu-openlib.cn/file?key=im9153gwi5lg)
=== ":material-book:`MATH10822`"  
    ...
    * 期中试卷
        * [2012年至今最全期中试卷真题资料包](http://api.cqu-openlib.cn/file?key=iVxHS3nk8q2d)@阳启万象
