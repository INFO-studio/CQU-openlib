...
!!! info "公告"
    ...
    - [2024 重庆大学 ACM 程序设计创新团队邀请赛暨新生赛报名中](限时活动/2024%20重庆大学%20ACM%20程序设计创新团队邀请赛暨新生赛报名中.md)

!!! note "最新动态"  
    - 增加[计算机控制技术](课程/计算机控制技术.md)页 `教材`  
    - 增加[数值计算与最优化](课程/数值计算与最优化.md)页 `教材`  
    - 增加[现代材料成型工程](课程/现代材料成型工程.md)页 `教材`  
    - 增加[机械设计](课程/机械设计.md)页 `教材`  
    - 增加[数学思维和数学文化](课程/数学思维和数学文化.md)页 `教材`  
