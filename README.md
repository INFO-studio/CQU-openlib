...
默认分支为 `main`。历史 MkDocs 站点代码见 `v1` 分支。
...
「课程」栏有独立的文件上传路径，您可使用[表单](https://cqu-openlib.cn/form/upload)来共享您的（或您收集的）各种圣遗物

资料包括但不限于：笔记、教材 pdf、教师 PPT（请得到教师允许）、期中期末试卷
...
- [cqu-openlib-docs](.agents/skills/cqu-openlib-docs/SKILL.md) — 改文档、收录教材
- [pdf-optimize](.agents/skills/pdf-optimize/SKILL.md) — 扫描版 PDF 文件优化
