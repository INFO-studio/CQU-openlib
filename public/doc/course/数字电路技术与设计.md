## 资源  
=== ":l-book:`CSE20015`"  
    * [教材](http://api.cqu-openlib.cn/file?key=iKo0v23u03ih) - :l-quote:`数字电子技术基础` - :l-user:`阎石` - :l-printer:`高等教育出版社`  
        * [教材习题解答](http://api.cqu-openlib.cn/file?key=iwctC23u0abc) - :l-quote:`数字电子技术基础学习辅导与习题解答` - :l-user:`阎石` - :l-printer:`高等教育出版社`  
    * [教材](http://api.cqu-openlib.cn/file?key=iECag23u1lbe) - :l-quote:`EDA技术实用教程` - :l-user:`黄继业` - :l-printer:`科学出版社`  
    * 课件  
