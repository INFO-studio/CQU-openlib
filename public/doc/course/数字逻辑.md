...
## 资源  
=== ":l-book:`CST21116`"  
    * [教材](http://api.cqu-openlib.cn/file?key=i9JIq28sfjib) - :l-quote:`数字逻辑基础与Verilog设计` - :l-user:`Stephen Brown` - :l-printer:`机械工业出版社`  
    * [教材](http://api.cqu-openlib.cn/file?key=icMuj35e06ih) - :l-quote:`逻辑与数字系统设计（Verilog版）` - :l-user:`张晶皎` - :l-printer:`清华大学出版社`  
    * 课件
