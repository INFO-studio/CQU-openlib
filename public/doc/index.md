...
!!! info "公告"
    ...
    * [更新日志](sundry/更新日志/index.md) / [2026-08-05](sundry/更新日志/2026/2026-08/2026-08-05.md)
...
渠道包括但不限于：[站长](contributor/茵符草.md)QQ `2247977881`、表单、Github Issue、邮箱  

「课程」栏有独立的文件上传路径，您可使用[文件上传](/form/upload)来共享您的（或您收集的）各种圣遗物

资料包括但不限于：笔记、教材pdf、教师PPT（请得到教师允许）、期中期末试卷  

若要补充特定信息，也可使用其他表单：例如[教材收集](/form/textbook)、[页面反馈](/form/feedback)（页脚「问题反馈」亦可）、[社团信息](/form/club)、[学生团体收录](/form/group)。更多说明见[说明书](sundry/说明书/index.md)。  
...
!!! failure "提醒"  
    请注意我们是一个纯非盈利性质的组织，也并非官方机构。目前我们并不会考虑开通打赏渠道，同样，也不接受任何推广服务。如您认为您的版权受到了侵犯，请邮箱联系 `contact@cqu-openlib.cn`，我们会为您删掉对应的数据。  
